...
sys.path.append('C:/Users/Mitfo/AppData/Local/Programs/Python/Python39/Lib/site-packages/tensorflow')
...
def main():
    ...
    for day in all_days:
        for star in (1, 2):
            ...
            start_time = datetime(2020, 12, day, 6, 0, 0)
    ...
    total_points = 0
    xs.append(datetime(2020, 12, 1, 6, 0, 0))
    ys.append(0)
    ...
    event_start = datetime(2020, 12, 1, 0, 0, 0)
    next_day = datetime(2020, 12, max(all_days) + 1, 0, 0, 0)
